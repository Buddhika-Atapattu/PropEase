...
export interface CoTenant {
  fullName: string; email: string; phoneCode: string; phoneNumber: string;
...
export class TenantService {
  ...
  private readonly URLS_TENANT = {
    ...
    getAllTenants: () => `${this.API_TENANT_ROOT}/get-all-tenants`,
  ...
  public async getAllLeases(): Promise<MSG> {
    try {return await firstValueFrom(this.http.get<MSG>(this.URLS_LEASE.allLeases()));}
    catch(e) {return this.mapError(e);}
  }
  ...
  public async getAllTenants(): Promise<MSG> {
    try {return await firstValueFrom(this.http.get<MSG>(this.URLS_TENANT.getAllTenants()));}
    catch(e) {return this.mapError(e);}
  }
